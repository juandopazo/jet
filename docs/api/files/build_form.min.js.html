...
*/
jet.add("form",function(a){a.FormField=a.Base.create("formfield",a.Widget,[a.WidgetChild],{ATTRS:{value:{value:""},label:{value:""},htmlType:{value:"text"}}},{CONTENT_TEMPLATE:"&lt;label/&gt;",_syncDom2Attr:function(b){this.set(b,this._inputNode.attr(b))},_syncAttr2Dom:function(b){this._inputNode.attr(b.attrName,b.newVal)},initializer:function(){this._inputNode=a("&lt;input/&gt;").attr({id:this.get("id")+"_input"});this.after("valueChange",this._syncAttr2Dom);this.after("legendChange",this.syncUI)},renderUI:function(b,
c){this._inputNode.attr("type",this.get("htmlType")).value(this.get("value")).prependTo(b);c.attr("htmlFor",this._inputNode.attr("id"))},bindUI:function(){this._handlers.push(this._inputNode.on("change",a.bind(this._syncDom2Attr,this,"value")))},syncUI:function(){this.get("contentBox").html(this.get("label"))}});a.CheckBox=a.Base.create("checkbox",a.FormField,[],{ATTRS:{checked:{value:false},htmlType:{value:"checkbox"}}},{initializer:function(){this.after("checkedChange",this._syncAttr2Dom)},bindUI:function(){this._handlers.push(this._inputNode.on("click",
