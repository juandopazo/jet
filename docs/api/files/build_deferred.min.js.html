...
this._fail=[]}e.each(b,function(f){f.apply(c,a)});return this},defer:function(a,b){var c=new this.constructor(this._config);this.then(d.bind(a,b||this,c));return c}});d.Promise=j;d.defer=function(a){var b=new d.Promise;a.call(d,b);return b};d.wait=d.Promise.prototype.wait=function(a){return this.defer(function(b){setTimeout(function(){b.resolve()},a)})};d.queue=function(a,b){b=b||10;i.isArray(a)||(a=[a]);var c=this;e.forEach(a,function(f){c=c.wait(b).then(f)});return c};d.when=d.Promise.prototype.when=
