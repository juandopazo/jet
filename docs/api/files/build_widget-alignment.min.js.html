...
*/
jet.add("widget-alignment",function(i){function l(){}var n=i.UA.support.fixed,p=i.DOM;i.WidgetAlignment=i.mix(l,{Top:"t",Middle:"m",Bottom:"b",Left:"l",Center:"c",Right:"r",TopLeft:"tl",TopCenter:"tc",TopRight:"tr",MiddleLeft:"ml",MiddleCenter:"mc",MiddleRight:"mr",BottomLeft:"bl",BottomCenter:"bc",BottomRight:"br"});l.prototype={_getPositionTop:function(c,e,d,g,a,b,h,j,k){var f=0;switch(c){case "m":f-=d/2;break;case "b":f-=d;break}switch(e){case "m":a+=g/2;break;case "b":a+=g;break}if(j&amp;&amp;!n)a+=p.scrollTop();
a+=f+b;if(k)if(a&lt;0)a=0;else if(a&gt;h-d)a=h-d;return a},_getPositionLeft:function(c,e,d,g,a,b,h,j,k){var f=0;switch(c){case "c":f-=d/2;break;case "r":f-=d;break}switch(e){case "c":a+=g/2;break;case "r":a+=g;break}if(j&amp;&amp;!n)a+=p.scrollLeft();a+=f+b;if(k)if(a&lt;0)a=0;else if(a&gt;h-d)a=h-d;return a},_getPositionBottom:function(c,e,d,g,a){var b=0;switch(c){case "t":b-=e;break;case l.Middle:b-=e/2;break}b-=d;if(g&amp;&amp;!n)b-=p.scrollTop();if(a)b=Math.max(b,0);return b},_getPositionRight:function(c,e,d,g,a){var b=0;
switch(c){case "l":b-=e;break;case "c":b-=e/2;break}b-=d;if(g&amp;&amp;!n)b-=p.scrollTop();if(a)b=Math.max(b,0);return b},_repositionUI:function(){var c=this.get("align"),e=c.points||[l.TopLeft,l.TopLeft],d=c.offset||[0,0];c=c.node?i(c.node):null;var g=this.get("alignedNode"),a=c?c.offset():null,b=g.offset(),h=this.get("fixed"),j=this.get("constrain"),k=p.screenSize(),f=e[0],o=e[1];e=f.substr(0,1);f=f.substr(1);var q=o.substr(0,1);o=o.substr(1);var r=i.bind(this._getPositionLeft,this),s=i.bind(this._getPositionTop,
this),m={};if(c){m={left:r(f,o,b.width,a.width,a.left,d[0]||0,k.width,h,j),top:s(e,q,b.height,a.height,a.top,d[1]||0,k.height,h,j)};g.position(m.left,m.top)}else{if(q=="b")m.bottom=this._getPositionBottom(e,b.height,d[1],h,j)+"px";else m.top=s(e,q,b.height,k.height,0,d[1]||0,k.height,h,j)+"px";if(o=="r")m.right=this._getPositionRight(f,b.width,d[0],h,j)+"px";else m.left=r(f,o,b.width,k.width,0,d[0]||0,k.width,h,j)+"px";g.css(m)}}};i.mix(l,{ATTRS:{fixed:{value:false},constrain:{value:false},align:{valueFn:function(){return{points:[l.TopLeft,
l.TopLeft],offset:[0,0]}}},alignedNode:{value:"boundingBox",getter:function(c){return i.Lang.isString(c)?this.get(c):c}}},EVENTS:{render:function(){var c=this.get("fixed"),e=i(i.config.win);this.get("alignedNode").css("position",c&amp;&amp;n?"fixed":"absolute");this._handlers.push(e.on("resize",this._repositionUI,this));c&amp;&amp;!n&amp;&amp;this._handlers.push(e.on("scroll",this._repositionUI,this));this._repositionUI()},afterRender:"_repositionUI",afterFixedChange:"_repositionUI",afterConstrainChange:"_repositionUI",
afterAlignChange:"_repositionUI",afterWidthChange:"_repositionUI",afterHeightChange:"_repositionUI"}})});
