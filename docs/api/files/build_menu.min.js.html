...
*/
jet.add("menu",function(b){b.MenuItem=b.Base.create("menuitem",b.Widget,[b.WidgetChild,b.WidgetParent,b.WidgetAlignment],{ATTRS:{labelNode:{value:"&lt;span/&gt;",setter:b},label:{value:""},align:{valueFn:function(){return{points:["tl","bl"],offset:[0,0]}}},constrain:{value:true},defaultChildType:{value:"MenuItem"}}},{BOUNDING_TEMPLATE:"&lt;li/&gt;",CONTENT_TEMPLATE:"&lt;a/&gt;",CONTAINER_TEMPLATE:"&lt;ul/&gt;",_toggleContainer:function(a){this._childrenContainer.toggleClass(this.getClassName("container","hidden"),this.size()==
0?true:!a)},_updateLabel:function(a){this.get("labelNode").html(a)},initializer:function(){this.set("labelNode",this.get("labelNode"));this._childrenContainer=b(this.CONTAINER_TEMPLATE);this.set("alignedNode",this._childrenContainer);this.get("align").node=this.get("contentBox");this.after("labelContentChange",function(a){this._updateLabel(a.newVal)});this.after("selectedChange",function(){b.wait(0,this,this._repositionUI)})},renderUI:function(a,c){c.attr("href","#").append(this.get("labelNode").addClass(this.getClassName("label")));
this._childrenContainer.addClass(this.getClassName("container")).appendTo(a)},bindUI:function(){this.after("selectedChange",function(a){this._toggleContainer(a.newVal)});this.on("click",function(a){if(a.currentTarget===this){a.domEvent.preventDefault();this.set("selected",!this.get("selected"))}})},syncUI:function(){this._toggleContainer(this.get("selected"));this._updateLabel(this.get("label"))}});b.MenuBar=b.Base.create("menubar",b.Widget,[b.WidgetParent],{ATTRS:{defaultChildType:{value:"MenuItem"}}},
{CONTENT_TEMPLATE:"&lt;ul/&gt;",renderUI:function(){this.size()&gt;0&amp;&amp;this.item(0).unselect()},bindUI:function(a){this._handlers.push(b(b.config.doc).on("click",function(c){var d=this.get("selection");d&amp;&amp;!a.contains(c.target)&amp;&amp;d.unselect()},this))}});b.SimpleMenu=b.Base.create("simplemenu",b.Widget,[b.WidgetParent],{ATTRS:{defaultChildType:{value:"MenuItem"},multiple:{value:false}}},{CONTENT_TEMPLATE:"&lt;ul/&gt;",_smPreventNoSelection:function(a){var c=this.get("selection");if(!a.newVal&amp;&amp;(!c||c===a.target))a.preventDefault()},
initializer:function(){this.after("addChild",function(a){a.child.on("selectedChange",this._smPreventNoSelection,this)})}})});
