...
a._domEventChildrenProxy)});this.forEach(function(c){c.render(b)})},_onChildSelect:function(a){if(a.src!=="_onSelectionChange"){var b=null;if(this.get(i)){b=[];this.forEach(function(c){c.get(e)&&b.push(c)})}else if(a.newVal)b=a.target;this.set(j,b)}},_unHookChild:function(a){var b=a.target.get("index");this.splice(b,1);this.forEach(function(c,f){f>=b&&c.set("index",f)})},_domEventChildrenProxy:function(a){var b=l.getByNode(a.domEvent.target);this.indexOf(b)>-1&&b.fire(a.type,{domEvent:a.domEvent})},
_add:function(a,b){var c=a.childType||this.get("childType");if(a&&this.fire("addChild",{child:a,index:b})){if(d.instanceOf(a,d.Widget))a.set("parent",this);else{a.parent=this;a.index=b;a=new c(a)}this.splice(b,0,a);this.get("rendered")&&a.render(this.get("childrenContainer"));a.after("selectedChange",this._onChildSelect,this);a.on("destroy",this._unHookChild,this);this.fire("afterAddChild",{child:a,index:b})}return a},addChild:function(a,b){var c=this;h.isNumber(b)||(b=this.size());return h.isArray(a)?
d.Array.map(a,function(f,n){return c._add(f,b+n)}):this._add(a,b)},add:function(a,b){this.addChild(a,b);return this},remove:function(a){if(h.isNumber(a))a=this.item(a);if(a&&this.fire("removeChild",{child:a})){a.destroy();this.fire("afterRemoveChild",{child:a})}return this},first:function(){return this.item(0)},last:function(){return this.item(this.size()-1)},removeAll:function(){for(;this.size()>0;)this.remove(0);return this}};d.mix(g.prototype,d.ArrayList.prototype);d.mix(k,{NAME:"widget-child",
ATTRS:{selected:{value:false},index:{value:0},parent:{value:null},root:{readOnly:true,valueFn:function(){for(var a=this.get("parent");a.get("parent");)a=a.get("parent");return a}}},EVENTS:{render:function(){var a=this,b=this.get("boundingBox");d.Object.each(l.DOM_EVENTS,function(c){b.unbind(c,a._domEventProxy)});this.get(e)&&b.addClass(this.getClassName(e))}},HTML_PARSER:{selected:function(a){return a.hasClass(this.getClassName(e))}}});k.prototype={_childSelectedChange:function(a){this.get("boundingBox").toggleClass(this.getClassName(e),
