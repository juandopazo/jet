...
b.fire(a.type,{domEvent:a.domEvent})},_add:function(a,b){var c=this.get("childType");if(a&&this.fire("addChild",{child:a,index:b})){if(a instanceof c)a.set("parent",this);else{a.parent=this;a.index=b;a=new c(a)}this.splice(b,0,a);this.get("rendered")&&a.render(this.get("childrenContainer"));a.after("selectedChange",this._onChildSelect,this);a.on("destroy",this._unHookChild,this);this.fire("afterAddChild",{child:a,index:b})}},add:function(a,b){h.isNumber(b)||(b=this.size());h.isArray(a)?d.Array.forEach(a,
function(c,f){this._add(c,b+f)},this):this._add(a,b);return this},remove:function(a){if(h.isNumber(a))a=this.item(a);if(a&&this.fire("removeChild",{child:a})){a.destroy();this.fire("afterRemoveChild",{child:a})}return this},removeAll:function(){for(;this.size()>0;)this.remove(0);return this}};d.mix(g.prototype,d.ArrayList.prototype);d.mix(k,{NAME:"widget-child",ATTRS:{selected:{value:false},index:{value:0},parent:{value:null},root:{readOnly:true,getter:function(){for(var a=this.get("parent");a.get("parent");)a=
a.get("parent");return a}}},EVENTS:{render:function(){var a=this,b=this.get("boundingBox");d.Object.each(l.DOM_EVENTS,function(c){b.unbind(c,a._domEventProxy)});this.get(e)&&b.addClass(this.getClassName(e))}},HTML_PARSER:{selected:function(a){return a.hasClass(this.getClassName(e))}}});k.prototype={_childSelectedChange:function(a){this.get("boundingBox").toggleClass(this.getClassName(e),a.newVal)},select:function(){return this.set(e,true)},unselect:function(){return this.set(e,false)},toggle:function(){return this.set(e,
!this.get(e))},next:function(){return this.get("parent").get("children")[this.get("index")+1]||null},previous:function(){return this.get("parent").get("children")[this.get("index")-1]||null}};d.add({WidgetParent:g,WidgetChild:k})});
