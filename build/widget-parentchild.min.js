...
multiple:{value:false,wriceOnce:true},atLeastOne:{value:false},selectedIndex:{validator:function(a){return e.isNumber(a)&&!!this.item(a)},setter:function(a){var b=this.item(a);b&&b.select&&b.select();return a},getter:function(){var a=this.get("selection");return a?a.get("index"):-1}},childrenContainer:{setter:d,getter:function(a){return a||this.get("contentBox")}}},HTML_PARSER:{children:function(){var a,b=this.get("contentBox");b.children().forEach(function(c){a=a||[];a.push({srcNode:b,boundingBox:c})});
return a}}});g.prototype={constructor:g,_handleMultipleChildren:function(a,b){b&&!this.get("multiple")&&this.forEach(function(c){c!=b&&e.isFunction(c.unselect)&&c.unselect()})},_renderChildren:function(){var a=this,b=this.get("multiple"),c=b?[]:null;this.forEach(this.add,this);d.Object.each(i.DOM_EVENTS,function(f){a.on(f,a._domEventChildrenProxy)});this.forEach(function(f){if(f.get("selected"))if(b)c.push(f);else c=f});this.set("selection",c);c||this.set("selectedIndex",0)},_onChildSelect:function(a){var b=
