...
"hidden":"",zIndex:e.ovZindex+f-1,opacity:0.4}).width(d.width).height(d.height).appendTo(this.get("doc").body);this._handlers.push(a.on("resize",this._resizeModal,this));c.css("zIndex",e.ovZindex+f);this.on("mousedown",this.focus,this)},afterRender:function(){var a=this.get("boundingBox"),c=this.get("header");if(this.get("draggable"))this.dd=new b.Drag({node:a,handlers:c})},focus:function(){j.remove(this,e.overlays);e.overlays.push(this);var a=e.overlays,c,d=a.length;for(c=0;c<d;c++)a[c].get("boundingBox").css("zIndex",
