...
{add:function(a,f){var e;if(f){e={};e[a]=f}else e=a;this.get("options").push(e);s(this.get("combo")._node,a,f);return this},fill:function(a){var f=this;k.isArray(a)?r.each(a,function(e){f.add(e)}):v.each(a,f.add);return f},clear:function(){return myself.set("options",[])}});var o=function(){o.superclass.constructor.apply(this,arguments);var a=this,f={},e=function(c){return function(b){var h=f[c];h||(h=d("<div/>"));h.children().remove();k.isString(b)?h.html(b):h.append(b);return f[c]=h}};a.addAttrs({header:{setter:e("header"),
