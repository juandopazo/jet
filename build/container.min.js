...
initializer:function(){this.set("header",this.get("header"));this.set("body",this.get("body"));this.set("footer",this.get("footer"));i.each(["header","body","footer"],function(a){var c=this.get(a+"Content");a=this.get(a);if(d.isValue(c)){if(c.nodeType)c=b(c);c instanceof b.NodeList?a.append(c):a.html(c)}},this)},_uiHeaderChange:function(a){this.get("header").setContent(a.newVal)},_uiBodyChange:function(a){this.get("body").setContent(a.newVal)},_uiFooterChange:function(a){this.get("footer").setContent(a.newVal)},
renderUI:function(){var a=this.get("contentBox");i.each(["header","body","footer"],function(c){var j=this.get(c+"Content");c=this.get(c).addClass(c);d.isValue(j)&&c.appendTo(a)},this)},bindUI:function(){i.each(["Header","Body","Footer"],function(a){this.after(a.toLowerCase()+"ContentChange",this["_ui"+a+"Change"])},this)}});if(!f.overlays)f.overlays=[];if(!d.isNumber(f.ovZindex))f.ovZindex=10;b.Overlay=e.create("overlay",b.Module,[b.WidgetAlignment,b.WidgetStack],{ATTRS:{draggable:{validator:function(){return!!b.Drag},
