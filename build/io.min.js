...
h.setParameter(null,j,f[j]);return g(h.transformToFragment(d,g.context))};else if(k.ActiveXObject)q=function(d,e,f){var h=new window.ActiveXObject("Msxml2.XSLTemplate.6.0"),j;h.stylesheet=e;e=h.createProcessor();e.input=d;for(j in f)f.hasOwnProperty(j)&&e.addParameter(j,f[j]);e.transform();return g(e.output)};return q(c,a,b)};g.extend(o,g.Deferred,{abort:function(){this._request&&this._request.abort&&this._request.abort();return this.reject()}},{addMethod:function(c,a){o.prototype[c]=function(b,d){var e=
!l.isObject(d)||l.isFunction(d)?{}:d,f=e.on||(e.on={}),h=f.success,j=f.failure;if(l.isFunction(d))h=d;return this.defer(function(i){f.success=g.bind(i.resolve,i);f.failure=g.bind(i.reject,i);this._request=a(b,e)}).then(h,j)}}});g.Transaction=o;var y={ajax:function(c,a){var b=s(),d=a.success,e=null,f=a.dataType,h=a.timeout||1E4,j=a.method||"GET",i=a.async||true,x=a.complete||function(){},A=function(){d&&d.apply(g,arguments);x.apply(g,arguments)},n=function(B,C,D){a.failure&&a.failure(B,C,D);x.apply(g,
...
r.each(y,o.addMethod);r.each(y,function(c){g[c]=function(){var a=new g.Transaction;return a[c].apply(a,arguments)}})});
