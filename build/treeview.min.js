...
this.get("root").fire("node:"+a,this)){e.toggleClass(i,c).toggleClass(h,!c);j.toggleClass(k,c).toggleClass(l,!c)}}});b.TreeView=b.Base.create("treeview",b.Widget,[b.WidgetParent],{ATTRS:{defaultChildType:{value:"TreeNode"},multiple:{value:true}}},{})});
