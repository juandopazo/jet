...
true:!a)},_updateLabel:function(a){this.get("labelNode").html(a)},initializer:function(){this.set("labelNode",this.get("labelNode"));this._container=b(this.CONTAINER_TEMPLATE);this.set("childrenContainer",this._container);this.set("alignedNode","childrenContainer");this.get("align").node=this.get("contentBox");this.after("labelContentChange",function(a){this._updateLabel(a.newVal)});this.after("selectedChange",this._repositionUI)},renderUI:function(a,c){c.attr("href","#").append(this.get("labelNode").addClass(this.getClassName("label")));
