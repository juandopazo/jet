...
c.set("visible",a.newVal)}},renderUI:function(a,c){var d=this.get("align");d.node=a;d=this._olay=new b.Overlay({align:d,visible:this.get("selected")});this.get("labelNode").addClass(this.getClassName("label")).appendTo(c);if(this.get("children").length>0){d.render(a);a.addClass(this.getClassName("submenu"))}this.get("childrenContainer").addClass(this.getClassName("container")).appendTo(d.get("body"))},bindUI:function(){this._handlers.push(this.get("contentBox").on("click",this._toggleSelected,this));
this.on("mouseover",this._uiMenuMouseover);this.on("mouseout",this._uiMenuMouseout);this.after("labelContentChange",this._uiMenuLabelContentChange);this.after("selectedChange",this._uiMenuAfterSelected)},syncUI:function(){this.get("labelNode").setContent(this.get("labelContent"))},_toggleSelected:function(a){a.preventDefault();this.toggle()}});b.Menu=e.create("menu",f,[b.WidgetParent],{ATTRS:{defaultChildType:{value:"MenuItem"},align:{value:{align:[b.WidgetAlignment.TopLeft,b.WidgetAlignment.BottomLeft]}},
multiple:{value:false,readOnly:true},interaction:{value:"os",writeOnce:true}},EVENTS:{addChild:function(a){a=a.child;if(!(a instanceof b.MenuItem))a.align=a.align||this.get("align")},afterAddChild:function(a){a=a.child;if(this.get("interaction")=="os"){a._handlers.push(a.on("mouseover",b.bind(this._onMenuMouseOver,this)));a._handlers.push(a.on("mouseout",b.bind(this._onMenuMouseOut,this)))}},click:function(a){a=a.domEvent.target;if(!this.get("multiple")&&a==this.get("boundingBox")[0]||a==this.get("contentBox")[0])(a=
this.get("selection"))&&a.unselect()}}},{CONTENT_TEMPLATE:"<ul/>",_onMenuMouseOver:function(){this._menuTimeout&&clearTimeout(this._menuTimeout)},_onMenuMouseOut:function(){var a=this;this._menuTimeout&&clearTimeout(this._menuTimeout);this._menuTimeout=setTimeout(function(){var c=a.get("selection");if(g.isArray(c))h.each(c,function(d){d.unselect()});else c&&c.unselect()},1E3)},initializer:function(){if(this.get("interaction")=="os"){this.on("mouseout",this._onMenuMouseOut);this.on("mouseover",this._onMenuMouseOver)}}})});
