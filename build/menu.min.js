...
multiple:{value:false,readOnly:true},interaction:{value:"os",writeOnce:true}},EVENTS:{addChild:function(a){a=a.child;if(!(a instanceof b.MenuItem))a.align=a.align||this.get("align")},afterAddChild:function(a){a=a.child;if(this.get("interaction")=="os"){a._handlers.push(a.on("mouseover",b.bind(this._onMenuMouseOver,this)));a._handlers.push(a.on("mouseout",b.bind(this._onMenuMouseOut,this)))}}}},{CONTENT_TEMPLATE:"<ul/>",_onMenuMouseOver:function(){this._menuTimeout&&clearTimeout(this._menuTimeout)},
_onMenuMouseOut:function(){var a=this;this._menuTimeout&&clearTimeout(this._menuTimeout);this._menuTimeout=setTimeout(function(){var c=a.get("selection");if(g.isArray(c))h.each(c,function(d){d.unselect()});else c&&c.unselect()},1E3)},initializer:function(){if(this.get("interaction")=="os"){this.on("mouseout",this._onMenuMouseOut);this.on("mouseover",this._onMenuMouseOver)}}})});
