...
d.get("src");d.get("type")=="png"&&c.UA.ie?a.css("filter","progid:DXImageTransform.Microsoft.AlphaImageLoader (src='"+e+"',sizingMethod='crop');"):a.css("backgroundImage","url("+e+")")};d.get("loaded")?b():d.on("load",b);return d}});var j=function(){j.superclass.constructor.apply(this,arguments);var a=this.addAttrs({srcs:{validator:i.isArray}}),d=0;a.load=function(){var b=a.get("srcs"),e=b.length;k.each(b,function(f){var g=new h({src:f,on:{load:function(){a.fire("image:load",g)},error:function(){a.fire("image:error",
g)},timeout:function(){a.fire("image:timeout",g)},complete:function(){a.fire("image:complete",g);d++;a.fire("progress",Math.round(d*100/e),g);d==e&&a.fire("complete")}}});g.load()});return a}};c.extend(j,c.Base);c.add({Image:h,ImageLoader:j})});
