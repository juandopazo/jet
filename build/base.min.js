...
j){this.on(i,h.isString(j)?this[j]:j)};this._handlers=[d(d.config.win).on(t,this.destroy,this)];l.each(g,f,this);for(g=0;g<e.length;g++){e[g].EVENTS&&l.each(e[g].EVENTS,f,this);k.each(e[g].EXTS||[],function(i){i.apply(b,c);l.each(i.EVENTS||{},function(j,o){b.on(j,o)})});e[g][q].hasOwnProperty("initializer")&&e[g][q].initializer.call(this,a)}}var l=d.Object,h=d.Lang,k=d.Array,s=Array.prototype.slice,u=d.extend,q="prototype",t="unload",m=jet.namespace("Widget._instances");d.EventFacade=function(a,b,
c,e){this.type=a;this.target=b;this.preventDefault=function(){c&&c()};this.halt=function(){this.preventDefault()};l.each(e||{},function(g,f){h.isValue(this[g])||(this[g]=f)},this)};d.mix(r.prototype,{_attach:function(a,b){b.o=b.o||this;var c=this._events;c[a]||(c[a]=[]);h.isObject(b.fn)&&c[a].push(b);return this},_on:function(a,b,c,e){h.isObject(a)?l.each(a,function(g,f){this._attach(g,{fn:f,o:b,once:e})},this):this._attach(a,{fn:b,o:c,once:e});return this},on:function(a,b,c){return this._on(a,b,
c)},once:function(a,b,c){return this._on(a,b,c,true)},after:function(a,b,c){return this.on("after"+a.charAt(0).toUpperCase()+a.substr(1),b,c)},unbind:function(a,b){var c=this._events[a]||[],e,g=0;if(a&&b)for(;g<c.length;)if(c[g].fn==b)c.splice(g,1);else g++;else if(a)this._events[a]=[];else for(e in this._events)if(this._events.hasOwnProperty(e))this._events[e]=[];return this},fire:function(a,b){for(var c=this._events[a]=this._events[a]||[],e=true,g=new d.EventFacade(a,this,function(){e=false},b),
f=0;f<c.length;){h.isFunction(c[f].fn)&&c[f].fn.call(c[f].o,g);if(!c[f]||c[f].once)c.splice(f,1);else f++}return e}});d.EventTarget=r;d.extend(n,r,{addAttr:function(a,b){this._attrs[a]=b;var c=this._state,e=h.isValue(c[a]);b.readOnly&&e&&delete c[a];if(h.isString(b.setter))b.setter=this[b.setter];if(h.isString(b.getter))b.getter=this[b.getter];if(e&&b.setter)c[a]=b.setter.call(this,c[a]);return this},_set:function(a,b,c){var e=this._attrs,g=this._state,f=e[a]=e[a]||{},i=g[a],j;if(!f.readOnly){if(!f.validator||
f.validator.call(this,b)){if(f.setter)b=f.setter.call(this,b);if(!h.isValue(g[a])&&f.value)g[a]=i=f.value;j={newVal:b,prevVal:i,attrName:a};h.isObject(c)&&d.mix(j,c);if(b!==i&&this.fire(a+"Change",j)){g[a]=b;this.fire("after"+h.capitalize(a)+"Change",j)}}if(f.writeOnce&&!f.readOnly)e[a].readOnly=true}return this},get:function(a){var b=this._attrs,c=this._state;b[a]=b[a]||{};var e=b[a];if(e.writeOnce&&!e.readOnly)b[a].readOnly=true;h.isValue(c[a])||(c[a]=e.valueFn?e.valueFn():e.value);return e.getter?
e.getter.call(this,c[a],a):c[a]},set:function(a,b,c){h.isObject(a)?l.each(a,function(e,g){this._set(e,g,c)},this):this._set(a,b,c);return this},unset:function(a){delete this._state[a];return this},addAttrs:function(a){l.each(a,this.addAttr,this);return this},getAttrs:function(){var a={},b=this;l.each(this._state,function(c){a[c]=b.get(c)});return a}});d.Attribute=n;d.extend(p,n,{destroy:function(){if(this.fire("destroy")){k.each(this._classes,function(a){a.prototype.hasOwnProperty("destructor")&&
a.prototype.destructor.call(this)},this);k.each(this._handlers,function(a){a.detach&&a.detach()});this.unbind()}}},{ATTRS:{on:{getter:function(a){return a||{}}}},create:function(a,b,c,e,g){function f(){f.superclass.constructor.apply(this,arguments)}c=c||[];u(f,b||p,g,e||{});d.mix(f,{NAME:a,EXTS:c},true);k.each(c,function(i){d.mix(f[q],i[q]);l.each(i,function(j,o){if(f[j])h.isObject(f[j])&&h.isObject(o)&&d.mix(f[j],o);else f[j]=o})});return f}});d.Base=p;d.Utility=d.Base.create("utility",d.Base,[],
{CSS_PREFIX:"jet",ATTRS:{cssPrefix:{getter:function(a){return a||d.Utility.CSS_PREFIX},writeOnce:true}}},{getClassName:function(){return[this.get("classPrefix"),this.constructor.NAME].concat(s.call(arguments)).join("-")}});d.Widget=d.Base.create("widget",d.Base,[],{CSS_PREFIX:"jet",NAME:"widget",DOM_EVENTS:{click:1,keypress:1,mousedown:1,mouseup:1,mouseover:1,mouseout:1},ATTRS:{srcNode:{value:d(d.context.body),setter:d},classPrefix:{writeOnce:true,getter:function(a){return a||d.Widget.CSS_PREFIX}},
