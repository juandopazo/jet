...
d.indexOf(f)===0:e==="$="?d.substr(d.length-f.length)===f:e==="|="?d===f||d.substr(0,f.length+1)===f+"-":false},POS:function(a,b,c,d){var e=j.setFilters[b[2]];if(e)return e(a,c,b,d)}}},E=j.match.POS,F=function(a,b){return"\\"+(b-0+1)};for(var v in j.match){j.match[v]=RegExp(j.match[v].source+/(?![^\[]*\])(?![^\(]*\))/.source);j.leftMatch[v]=RegExp(/(^(?:.|\r|\n)*?)/.source+j.match[v].source.replace(/\\(\d+)/g,F))}var q=function(a,b){a=Array.prototype.slice.call(a,0);if(b){b.push.apply(b,a);return b}return a};
try{Array.prototype.slice.call(document.documentElement.childNodes,0)}catch(G){q=function(a,b){var c=b||[],d=0;if(A.call(a)==="[object Array]")Array.prototype.push.apply(c,a);else if(typeof a.length==="number")for(var e=a.length;d<e;d++)c.push(a[d]);else for(;a[d];d++)c.push(a[d]);return c}}var t,r;if(document.documentElement.compareDocumentPosition)t=function(a,b){if(a===b){s=true;return 0}if(!a.compareDocumentPosition||!b.compareDocumentPosition)return a.compareDocumentPosition?-1:1;return a.compareDocumentPosition(b)&
4?-1:1};else{t=function(a,b){var c=[],d=[],e=a.parentNode,f=b.parentNode,g=e;if(a===b){s=true;return 0}else if(e===f)return r(a,b);else if(e){if(!f)return 1}else return-1;for(;g;){c.unshift(g);g=g.parentNode}for(g=f;g;){d.unshift(g);g=g.parentNode}e=c.length;f=d.length;for(g=0;g<e&&g<f;g++)if(c[g]!==d[g])return r(c[g],d[g]);return g===e?r(a,d[g],-1):r(c[g],b,1)};r=function(a,b,c){if(a===b)return c;for(a=a.nextSibling;a;){if(a===b)return-1;a=a.nextSibling}return 1}}i.getText=function(a){for(var b=
...
for(var g=f.length;e<g;e++)i(a,f[e],c);return i.filter(d,c)};window.Sizzle=i})();
