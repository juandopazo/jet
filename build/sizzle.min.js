...
[h]).length>0){k=h;break}}h=h[a]}d[e]=k}}}var w=/((?:\((?:\([^()]+\)|[^()]+)+\)|\[(?:\[[^\[\]]*\]|['"][^'"]*['"]|[^\[\]'"]+)+\]|\\.|[^ >+~,(\[\\]+)+|[>+~])(\s*,\s*)?((?:.|\r|\n)*)/g,x=0,A=Object.prototype.toString,s=false,B=true;[0,0].sort(function(){B=false;return 0});var i=function(a,b,c,d){c=c||[];var e=b=b||document;if(b.nodeType!==1&&b.nodeType!==9)return[];if(!a||typeof a!=="string")return c;var f=[],g,h,k,o,m=true,p=i.isXML(b),n=a,l;do{w.exec("");if(g=w.exec(n)){n=g[3];f.push(g[1]);if(g[2]){o=
...
i.filter(g.expr,g.set):g.set;if(f.length>0)k=q(h);else m=false;for(;f.length;){g=l=f.pop();if(j.relative[l])g=f.pop();else l="";if(g==null)g=b;j.relative[l](k,g,p)}}else k=[]}k||(k=h);k||i.error(l||a);if(A.call(k)==="[object Array]")if(m)if(b&&b.nodeType===1)for(a=0;k[a]!=null;a++){if(k[a]&&(k[a]===true||k[a].nodeType===1&&i.contains(b,k[a])))c.push(h[a])}else for(a=0;k[a]!=null;a++)k[a]&&k[a].nodeType===1&&c.push(h[a]);else c.push.apply(c,k);else q(k,c);if(o){i(o,e,c,d);i.uniqueSort(c)}return c};
i.uniqueSort=function(a){if(t){s=B;a.sort(t);if(s)for(var b=1;b<a.length;b++)a[b]===a[b-1]&&a.splice(b--,1)}return a};i.matches=function(a,b){return i(a,null,null,b)};i.matchesSelector=function(a,b){return i(b,null,null,[a]).length>0};i.find=function(a,b,c){var d;if(!a)return[];for(var e=0,f=j.order.length;e<f;e++){var g=j.order[e],h;if(h=j.leftMatch[g].exec(a)){var k=h[1];h.splice(1,1);if(k.substr(k.length-1)!=="\\"){h[1]=(h[1]||"").replace(/\\/g,"");d=j.find[g](h,b,c);if(d!=null){a=a.replace(j.match[g],
"");break}}}}d||(d=b.getElementsByTagName("*"));return{set:d,expr:a}};i.filter=function(a,b,c,d){for(var e=a,f=[],g=b,h,k,o=b&&b[0]&&i.isXML(b[0]);a&&b.length;){for(var m in j.filter)if((h=j.leftMatch[m].exec(a))!=null&&h[2]){var p=j.filter[m],n,l;l=h[1];k=false;h.splice(1,1);if(l.substr(l.length-1)!=="\\"){if(g===f)f=[];if(j.preFilter[m])if(h=j.preFilter[m](h,g,c,f,d,o)){if(h===true)continue}else k=n=true;if(h)for(var u=0;(l=g[u])!=null;u++)if(l){n=p(l,h,u,g);var D=d^!!n;if(c&&n!=null)if(D)k=true;
else g[u]=false;else if(D){f.push(l);k=true}}if(n!==undefined){c||(g=f);a=a.replace(j.match[m],"");if(!k)return[];break}}}if(a===e)if(k==null)i.error(a);else break;e=a}return g};i.error=function(a){throw"Syntax error, unrecognized expression: "+a;};var j=i.selectors={order:["ID","NAME","TAG"],match:{ID:/#((?:[\w\u00c0-\uFFFF\-]|\\.)+)/,CLASS:/\.((?:[\w\u00c0-\uFFFF\-]|\\.)+)/,NAME:/\[name=['"]*((?:[\w\u00c0-\uFFFF\-]|\\.)+)['"]*\]/,ATTR:/\[\s*((?:[\w\u00c0-\uFFFF\-]|\\.)+)\s*(?:(\S?=)\s*(['"]*)(.*?)\3|)\s*\]/,
...
d.indexOf(f)===0:e==="$="?d.substr(d.length-f.length)===f:e==="|="?d===f||d.substr(0,f.length+1)===f+"-":false},POS:function(a,b,c,d){var e=j.setFilters[b[2]];if(e)return e(a,c,b,d)}}},E=j.match.POS,F=function(a,b){return"\\"+(b-0+1)};for(var v in j.match){j.match[v]=new RegExp(j.match[v].source+/(?![^\[]*\])(?![^\(]*\))/.source);j.leftMatch[v]=new RegExp(/(^(?:.|\r|\n)*?)/.source+j.match[v].source.replace(/\\(\d+)/g,F))}var q=function(a,b){a=Array.prototype.slice.call(a,0);if(b){b.push.apply(b,a);
return b}return a};try{Array.prototype.slice.call(document.documentElement.childNodes,0)}catch(G){q=function(a,b){var c=b||[],d=0;if(A.call(a)==="[object Array]")Array.prototype.push.apply(c,a);else if(typeof a.length==="number")for(var e=a.length;d<e;d++)c.push(a[d]);else for(;a[d];d++)c.push(a[d]);return c}}var t,r;if(document.documentElement.compareDocumentPosition)t=function(a,b){if(a===b){s=true;return 0}if(!a.compareDocumentPosition||!b.compareDocumentPosition)return a.compareDocumentPosition?
-1:1;return a.compareDocumentPosition(b)&4?-1:1};else{t=function(a,b){var c=[],d=[],e=a.parentNode,f=b.parentNode,g=e;if(a===b){s=true;return 0}else if(e===f)return r(a,b);else if(e){if(!f)return 1}else return-1;for(;g;){c.unshift(g);g=g.parentNode}for(g=f;g;){d.unshift(g);g=g.parentNode}e=c.length;f=d.length;for(g=0;g<e&&g<f;g++)if(c[g]!==d[g])return r(c[g],d[g]);return g===e?r(a,d[g],-1):r(c[g],b,1)};r=function(a,b,c){if(a===b)return c;for(a=a.nextSibling;a;){if(a===b)return-1;a=a.nextSibling}return 1}}i.getText=
function(a){for(var b="",c,d=0;a[d];d++){c=a[d];if(c.nodeType===3||c.nodeType===4)b+=c.nodeValue;else if(c.nodeType!==8)b+=i.getText(c.childNodes)}return b};(function(){var a=document.createElement("div"),b="script"+(new Date).getTime();a.innerHTML="<a name='"+b+"'/>";var c=document.documentElement;c.insertBefore(a,c.firstChild);if(document.getElementById(b)){j.find.ID=function(d,e,f){if(typeof e.getElementById!=="undefined"&&!f)return(e=e.getElementById(d[1]))?e.id===d[1]||typeof e.getAttributeNode!==
"undefined"&&e.getAttributeNode("id").nodeValue===d[1]?[e]:undefined:[]};j.filter.ID=function(d,e){var f=typeof d.getAttributeNode!=="undefined"&&d.getAttributeNode("id");return d.nodeType===1&&f&&f.nodeValue===e}}c.removeChild(a);c=a=null})();(function(){var a=document.createElement("div");a.appendChild(document.createComment(""));if(a.getElementsByTagName("*").length>0)j.find.TAG=function(b,c){var d=c.getElementsByTagName(b[1]);if(b[1]==="*"){for(var e=[],f=0;d[f];f++)d[f].nodeType===1&&e.push(d[f]);
d=e}return d};a.innerHTML="<a href='#'></a>";if(a.firstChild&&typeof a.firstChild.getAttribute!=="undefined"&&a.firstChild.getAttribute("href")!=="#")j.attrHandle.href=function(b){return b.getAttribute("href",2)};a=null})();document.querySelectorAll&&function(){var a=i,b=document.createElement("div");b.innerHTML="<p class='TEST'></p>";if(!(b.querySelectorAll&&b.querySelectorAll(".TEST").length===0)){i=function(d,e,f,g){e=e||document;if(!g&&!i.isXML(e))if(e.nodeType===9)try{return q(e.querySelectorAll(d),
f)}catch(h){}else if(e.nodeType===1&&e.nodeName.toLowerCase()!=="object"){var k=e.getAttribute("id"),o=e.id="__sizzle__";try{return q(e.querySelectorAll("#"+o+" "+d),f)}catch(m){}finally{if(k)e.id=k;else e.removeAttribute("id")}}return a(d,e,f,g)};for(var c in a)i[c]=a[c];b=null}}();(function(){var a=document.documentElement,b=a.matchesSelector||a.mozMatchesSelector||a.webkitMatchesSelector||a.msMatchesSelector,c=false;try{b.call(document.documentElement,"[test!='']:sizzle")}catch(d){c=true}if(b)i.matchesSelector=
function(e,f){if(!i.isXML(e))try{if(c||!j.match.PSEUDO.test(f)&&!/!=/.test(f))return b.call(e,f)}catch(g){}return i(f,null,null,[e]).length>0}})();(function(){var a=document.createElement("div");a.innerHTML="<div class='test e'></div><div class='test'></div>";if(!(!a.getElementsByClassName||a.getElementsByClassName("e").length===0)){a.lastChild.className="e";if(a.getElementsByClassName("e").length!==1){j.order.splice(1,0,"CLASS");j.find.CLASS=function(b,c,d){if(typeof c.getElementsByClassName!=="undefined"&&
