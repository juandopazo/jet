...
[],{ATTRS:{options:{value:[]},selected:{validator:b.Lang.isNumber,getter:function(){var a=this.get("contentBox").getDOMNode();return a.options[a.selectedIndex]},setter:function(a){var c=this.get("contentBox").getDOMNode();if(a>=0&&this.fire("change",c.options[a]))c.selectedIndex=a;return a}},count:{readOnly:true,getter:function(){return this.get("contentBox").getDOMNode().options.length}},value:{readOnly:true,getter:function(){var a=this.get("selected");return a&&(a.value?a.value:a.text)}}}},{CONTENT_TEMPLATE:"<select/>",
_setOptions:function(a,c){b.Array.forEach(c,function(d){b.Lang.isObject(d)?b.Object.each(d,function(h,i){f(a,h,i)}):f(a,d)})},_afterOptionsChange:function(a){var c=this.get("contentBox").getDOMNode();c.options.length=0;this._setOptions(c,a.newVal)},_setFieldValue:function(){},initializer:function(){this.after("optionsChange",this._afterOptionsChange)},renderUI:function(){this._setOptions(this.get("contentBox").getDOMNode(),this.get("options"))},bindUI:function(){var a=this;this._handlers.push(this.get("contentBox").on("change",
function(){a.fire("change",{newVal:this.options[this.selectedIndex]})}))},add:function(a,c){var d;if(c){d={};d[a]=c}else d=a;this.get("options").push(d);f(this.get("contentBox").getDOMNode(),a,c);return this},fill:function(a){b.Lang.isArray(a)?b.Array.forEach(a,function(c){this.add(c)},this):b.Object.each(a,this.add,this);return this},clear:function(){return this.set("options",[])},select:function(a){return this.set("selected",a)},toJSON:function(){var a=this.get("selected"),c={id:this.get("id"),
text:a.text};if(a.value)c.value=a.value;return c}});b.RadioButton=b.Base.create("radio",b.FormField,[],{},{CONTENT_TEMPLATE:"<input/>",_rbSelectedChange:function(a){if(a.newVal&&a.src!="dom")this.get("contentBox").getDOMNode().checked=true},_rbCheckedChange:function(){this.set("selected",this.get("contentBox").getDOMNode().checked,{src:"dom"})},_insertLabel:function(){this._labelNode.appendTo(this.get("boundingBox"))},initializer:function(){this.after("selectedChange",this._rbSelectedChange)},renderUI:function(){this.get("contentBox").attr({type:"radio",
