...
j.each(this._handlers,function(a){a.detach()})},getClassName:function(){return[this.get(p),this.constructor.NAME].concat(s.call(arguments)).join("-")}});var p="classPrefix",t="unload",u="destroy";if(!jet.Widget)jet.Widget={};if(!h.isNumber(jet.Widget._uid))jet.Widget._uid=-1;if(!jet.Widget._instances)jet.Widget._instances={};e.Widget=e.Base.create("widget",e.Base,[],{CSS_PREFIX:"jet",NAME:"widget",DOM_EVENTS:{click:1,keypress:1,mousedown:1,mouseup:1,mouseover:1,mouseout:1},ATTRS:{srcNode:{value:e(e.context.body),
...
getClassName:function(){return[this.get(p),this.constructor.NAME].concat(s.call(arguments)).join("-")}});var r=e.Mouse=e.Base.create("mouse",e.Utility,[],{ATTRS:{frequency:{value:20},tracking:{value:false,validator:h.isBoolean},capturing:{value:false,validator:h.isBoolean},shields:{readOnly:true,getter:"_buildShim"},shim:{value:false,validator:h.isBoolean},prevX:{value:0},prevY:{value:0}}},{_buildShim:function(){if(!r.shim){var a=this.get("pageSize");r.shim=e("<iframe/>").attr({frameborder:"0",src:"javascript:;"}).css({opacity:0,
