 ...
 * https://github.com/juandopazo/jet/blob/master/LICENSE.md
*/
jet.add("oop",function(c){var j=Object.prototype,i=c.Array,k=function(a){var b=function(){};b.prototype=a;return new b};c.extend=function(a,b,g,d){if(!b||!a)c.error("extend failed, verify dependencies");var e=b.prototype,f=k(e);a.prototype=f;f.constructor=a;a.superclass=e;if(b!=Object&&e.constructor==j.constructor)e.constructor=b;g&&c.mix(f,g,true);d&&c.mix(a,d,true);return a};var h=c.Class=function a(){for(var b=arguments,g=this._classes=[],d=this.constructor;d!==a;){g.unshift(d);d=d.superclass.constructor}i.each(g,
function(e){i.each(e.EXTS||[],function(f){f.apply(this,b)},this);e.prototype.hasOwnProperty("initializer")&&e.prototype.initializer.apply(this,b)},this)};c.mix(h,{NAME:"Class",toString:function(){return"class "+h.NAME},create:function(a,b,g,d,e){function f(){f.superclass.constructor.apply(this,arguments)}g=g||[];c.extend(f,b||h,e,d);c.mix(f,{NAME:a,create:function(l,m,n,o){return h.create(l,f,m,n,o)},mixin:function(){return h.mixin(f,Array.prototype.slice.call(arguments))},toString:function(){return"class "+
f.NAME}},true);return h.mixin(f,g)},mixin:function(a,b){if(!a.EXTS)a.EXTS=[];a.EXTS.push.apply(a.EXTS,b);i.each(b,function(g){c.mix(a.prototype,g.prototype);c.Hash.each(g,function(d,e){if(a[d])c.Lang.isObject(a[d])&&c.Lang.isObject(e)&&c.mix(a[d],e);else a[d]=e})});return a}},true)});
/**
 * @module node
 * @requires oop
 * 
...
d){this.on(c,h.isString(d)?this[d]:d)}a=a||{};j.each(this._classes,function(c){j.each(c.EXTS,function(d){m.each(d.EVENTS,b,this)},this);m.each(c.EVENTS,b,this)},this);m.each(a.on,b,this)}});e.Base.create=n.create;e.Utility=n.create("utility",e.Base,[],{CSS_PREFIX:"jet",ATTRS:{cssPrefix:{getter:function(a){return a||e.Utility.CSS_PREFIX},writeOnce:true}}},{initializer:function(){this._handlers=[e(this.get("win")).on(t,this.destroy,this)]},destroy:function(){this.fire(u)&&j.each(this._handlers,function(a){a.detach()})},
getClassName:function(){return[this.get(p),this.constructor.NAME].concat(s.call(arguments)).join("-")}});var p="classPrefix",t="unload",u="destroy";if(!jet.Widget)jet.Widget={};if(!h.isNumber(jet.Widget._uid))jet.Widget._uid=-1;if(!jet.Widget._instances)jet.Widget._instances={};e.Widget=n.create("widget",e.Base,[],{CSS_PREFIX:"jet",NAME:"widget",DOM_EVENTS:{click:1,keypress:1,mousedown:1,mouseup:1,mouseover:1,mouseout:1},ATTRS:{srcNode:{value:e(e.context.body),setter:e},classPrefix:{writeOnce:true,
getter:function(a){return a||e.Widget.CSS_PREFIX}},rendered:{value:false},boundingBox:{setter:e},contentBox:{setter:e},width:{validator:h.isNumber},height:{validator:h.isNumber},id:{},visible:{value:true,validator:h.isBoolean},disabled:{value:false,validator:h.isBoolean}},HTML_PARSER:{contentBox:function(){var a=this.get("boundingBox");if(a&&this.CONTENT_TEMPLATE)return a.first()}},getByNode:function(a){a=e(a)._nodes[0];for(var b=a.ownerDocument.documentElement;a&&a!=b;){if(a.id&&jet.Widget._instances[a.id])return jet.Widget._instances[a.id];
a=a.parentNode}return null}},{BOUNDING_TEMPLATE:"<div/>",CONTENT_TEMPLATE:"<div/>",_domEventProxy:function(a){this.fire(a.type,{domEvent:a})},show:function(){return this.set("visible",true)},hide:function(){return this.set("visible",false)},enable:function(){return this.set("enabled",true)},disable:function(){return this.set("enabled",false)},focus:function(){return this.set("focused",true)},blur:function(){return this.set("focused",false)},render:function(a){if(!this.get("rendered")){var b=this,
c=this.get("boundingBox"),d=this.get("contentBox"),f=this.get("srcNode"),i,g=this.get(p),k=[].concat(this._classes);m.each(e.Widget.DOM_EVENTS,function(l,o){o&&b._handlers.push(c.on(l,b._domEventProxy,b))});if(a){f=a;b.set("srcNode",a)}if(this.constructor==e.Widget)k=[e.Widget];else k.splice(0,4);j.each(["width","height"],function(l){var o=b.get(l);h.isNumber(o)&&c[l](o);b.after(l+"Change",function(q){newVal=h.isNumber(q.newVal)?q.newVal:"";b.get("boundingBox")[l](q.newVal)})});j.each(k,function(l){i=
[g,l.NAME].join("-");c.addClass(i);d.addClass([i,"content"].join("-"))});c._nodes[0]!=d._nodes[0]&&c.append(d.css("visibility","inherit"));c.attr("id")||c.attr("id",this.get("id"));this._toggleVisibility({newVal:this.get("visible")});this._toggleDisabled({newVal:this.get("disabled")});if(this.fire("render")){j.each(["renderUI","bindUI","syncUI"],function(l){j.each(k,function(o){o.prototype.hasOwnProperty(l)&&o.prototype[l].call(b,c,d)})});c.inDoc()||c.appendTo(f);this.set("rendered",true).focus();
setTimeout(function(){b.fire("afterRender")},0)}}return this},destroy:function(){if(this.fire(u)){j.each(this._classes,function(a){a.prototype.hasOwnProperty("destructor")&&a.prototype.destructor.call(this)},this);j.each(this._handlers,function(a){a.detach&&a.detach()});this.get("boundingBox").unbindAll(true).remove()}},_parseHTML:function(){var a=this,b=this.get("boundingBox");b._nodes[0]&&b.inDoc()&&j.each(this._classes,function(c){m.each(c.HTML_PARSER||{},function(d,f){var i=f.call(a,b);if(h.isValue(i)&&
(!(i instanceof e.NodeList)||i._nodes[0]))a.set(d,i)})})},_toggleVisibility:function(a){this.get("boundingBox").toggleClass(this.getClassName("hidden"),!a.newVal)},_toggleDisabled:function(a){this.get("boundingBox").toggleClass(this.getClassName("disabled"),a.newVal)},_widgetIdChange:function(a){this.get("boundingBox").attr("id",a.newVal);jet.Widget._instances[a.newVal]=this;delete jet.Widget._instances[a.prevVal]},initializer:function(){this._handlers=[e(e.config.win).on(t,this.destroy,this)];this._uid=
++jet.Widget._uid;var a=this.get("id");if(!a){a=this.getClassName(this._uid);this.set("id",a)}this.after("idChange",this._widgetIdChange);jet.Widget._instances[a]=this;this.get("boundingBox")||this.set("boundingBox",this.BOUNDING_TEMPLATE);this.get("contentBox")||this.set("contentBox",this.CONTENT_TEMPLATE||this.get("boundingBox"));this.after("visibleChange",this._toggleVisibility);this.after("disabledChange",this._toggleDisabled);this._parseHTML()},getClassName:function(){return[this.get(p),this.constructor.NAME].concat(s.call(arguments)).join("-")}});
var r=e.Mouse=e.Utility.create("mouse",[],{ATTRS:{frequency:{value:20},tracking:{value:false,validator:h.isBoolean},capturing:{value:false,validator:h.isBoolean},shields:{readOnly:true,getter:"_buildShim"},shim:{value:false,validator:h.isBoolean},prevX:{value:0},prevY:{value:0}}},{_buildShim:function(){if(!r.shim){var a=this.get("pageSize");r.shim=e("<iframe/>").attr({frameborder:"0",src:"javascript:;"}).css({opacity:0,position:"absolute",top:"0px",left:"0px",width:a.width,height:a.height,border:0,
zIndex:2E7}).appendTo(e.config.doc.body).hide()}return r.shim},_onTrackingChange:function(a){var b=this;if(a.newVal){if(!this.get("capturing")){this.get("shim")&&this.shim.show();this.interval=setInterval(function(){var c=b.get("clientX"),d=b.get("clientY");if(b.get("prevX")!=c||b.get("prevY")!=d){b.fire("mousemove",{clientX:c,clientY:d});b.set({prevX:c,prevY:d})}},this.get("frequency"));this.set("capturing",true)}}else{this.shim.hide();clearInterval(this.interval);this.set("capturing",false)}},_onSelectStart:function(a){this.get("capturing")&&
a.preventDefault()},_onMouseMove:function(a){this.set({clientX:a.clientX,clientY:a.clientY})},_onMouseUp:function(){this.set("tracking",false).fire("mouseup",{clientX:this.get("clientX"),clientY:this.get("clientY")})},initializer:function(){this.set("pageSize",e.DOM.pageSize());var a=this.shim=this._buildShim();this.after("trackingChange",this._onTrackingChange);var b=e(a._nodes[0].contentWindow.document);b.find("body").css({margin:0,padding:0});b.on("mousemove",this._onMouseMove,this);b.on("mouseup",
this._onMouseUp,this);b=e(e.config.doc);b.on("selectstart",this._onSelectStart,this);b.on("mousemove",this._onMouseMove,this);b.on("mouseup",this._onMouseUp,this);this.on("destroy",a.unbindAll,a)},down:function(){return this.set("tracking",true)},up:function(){return this.set("tracking",false)}});(function(){var a=new e.EventTarget,b,c,d,f=e.config.win,i=function(){var g=e.DOM.scrollLeft(),k=e.DOM.scrollTop();if(g!=c||k!=d)a.fire("scroll",{scrollLeft:g,scrollTop:k});else{clearInterval(b);b=null}c=
g;d=k};e(e.config.win).on("scroll",function(){b||(b=setInterval(i,50))});j.each(["on","once","fire"],function(g){e[g]=e.bind(a[g],a)});j.each(["load","unload"],function(g){e(f).on(g,function(){a.fire(g)})});e(f).on("resize",function(){a.fire("resize")})})()});
