...
{};settins.data[b]="jet.IO.jsonpCallbacks["+c+"]";f.Get.script(h+q(a.data));setTimeout(function(){if(!e){var i={message:"Request failed",reason:"Timeout"};a.error&&a.error(i);a.complete&&a.complete(i)}},a.timeout||1E4)}}});f.IO={utils:{parseXML:r}}});
