...
{message:"Request failed",reason:f})});return b};b.onBeforeParse=function(d){e.on("beforeParse",function(f,c){b.set("tempData",d(c))});return b}};h.extend(o,h.Utility);var y=function(){y.superclass.constructor.apply(this,arguments);var a=this.addAttrs({url:{required:true}});a.set("requestLogic",function(b,e,g){var d=a.get("responseType");C.ajax({url:a.get("url"),data:b,dataType:d=="xml"?"xml":d=="text"?"text":"json",success:e,error:g})});a.sendRequest(a.get("initialRequest"))};h.extend(y,o);var z=
function(){z.superclass.constructor.apply(this,arguments);var a=this.addAttrs({jsonCallbackParam:{value:"p"},timeout:{value:1E4},url:{required:true}}),b=function(e){var g=[];if(p.isHash(e)){E.each(e,function(d,f){g[g.length]=d+"="+f});e=g.join("&")}return e};a.set("requestLogic",function(e,g){var d=jet.DataSource.jsonpCallbacks.length,f=false;jet.DataSource.jsonpCallbacks[d]=function(c){f=true;g(c)};h.Get.script(a.get("url")+b(e)+"&"+a.get("jsonCallbackParam")+"=jet.DataSource.jsonpCallbacks["+d+
"]");setTimeout(function(){f||a.fire("error",{message:"Request failed",reason:"timeout"})},a.get("timeout"))});a.sendRequest(a.get("initialRequest"))};h.extend(z,o);var A=function(){A.superclass.constructor.apply(this,arguments);var a=this.addAttrs({url:{required:true},dataType:{value:"text"}});a.set("requestLogic",function(b,e,g){a.get("responseType");C.flajax({url:a.get("url"),data:b,dataType:a.get("dataType"),success:e,error:g})});a.sendRequest(a.get("initialRequest"))};h.extend(A,o);var B=function(){B.superclass.constructor.apply(this,
arguments);var a=this.addAttr("localData",{required:true});a.set("requestLogic",function(b,e){var g=a.get("localData");p.isFunction(g)?e(g(b)):e(g)});a.sendRequest(a.get("initialRequest"))};h.extend(B,o);h.mix(o,{responseType:{JSON:"json",XML:"xml",TEXT:"text",JSARRAY:"jsarray"},Ajax:y,Get:z,Local:B,XDR:A});h.add({DataSource:o,Record:v,RecordSet:q})});
