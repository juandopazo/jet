...
return c}:function(c){this.get("node").style.left=c-d.pxToFloat(b.get("r"))/2+"px";return c}},cy:{getter:k(!e&&j.cy?j.cy:"cy"),setter:e?function(c){this.get("node").setAttribute("cy",c);return c}:function(c){this.get("node").style.top=c-d.pxToFloat(b.get("r"))/2+"px";return c}}})};d.extend(s,h);var D=function(a){a.node="line";D.superclass.constructor.apply(this,arguments);this.addAttrs({x1:{getter:k("x1"),setter:n("x1")},x2:{getter:k("x2"),setter:n("x2")},y1:{getter:k("y1"),setter:n("y1")},y2:{getter:k("y2"),
setter:n("y2")}})};d.extend(D,h);var t=function(a){a.node="image";t.superclass.constructor.apply(this,arguments)};d.extend(t,h);var u=function(a){a.node="text";u.superclass.constructor.apply(this,arguments)};d.extend(u,h);var v=function(a){a.node="path";v.superclass.constructor.apply(this,arguments);this.addAttrs({d:{getter:k("d"),setter:n("d")}})};d.extend(v,h);var w=e?function(){w.superclass.constructor.apply(this,arguments);var a=new h({node:"svg",xmlns:"http://www.w3.org/2000/svg",version:"1.1"});
this.addAttrs({width:{setter:function(b){a.set("width",b);return b}},height:{setter:function(b){a.set("height",b);return b}},boundingBox:{readOnly:true,getter:function(){return a}},className:{value:"vectorview"}})}:function(){w.superclass.constructor.apply(this,arguments);var a=d("<div/>").css({position:"relative",overflow:"hidden"});this.addAttrs({width:{setter:function(b){a.css("width",b);return b}},height:{setter:function(b){a.css("height",b);return b}},boundingBox:{readOnly:true,getter:function(){return a}},
className:{value:"vectorview"}})},l=function(a,b){return a.set("vector",b).appendTo(b.get("boundingBox"))};d.extend(w,d.Widget,{rectangle:function(a){return l(new p(a),this)},circle:function(a){return l(new s(a),this)},ellipse:function(a){return l(new C(a),this)},image:function(a){return l(new t(a),this)},text:function(a){return l(new u(a),this)},line:function(a){return l(new D(a),this)},path:function(a){return l(new v(a),this)},clear:function(){this.get("boundingBox").children().remove()}});d.mix(h,
{Circle:s,Rectangle:p,Image:t,Text:u,Path:v,decToHex:F,hexToDec:G,colorHexToArray:function(a){if(a.substr(0,1)=="#")a=a.substr(1);a=a.length==3?[a.substr(0,1)+a.substr(0,1),a.substr(1,1)+a.substr(1,1),a.substr(2,1)+a.substr(2,1)]:[a.substr(0,2),a.substr(2,2),a.substr(4,2)];i.each(a,function(b,c){a[c]=G(b)});return a},colorArrayToHex:function(a){for(var b=0;b<3;b++){a[b]=F(a[b]);if(a[b]<10)a[b]="0"+a[b]}return"#"+a.join("")}});d.add({VectorView:w,Vector:h})});
