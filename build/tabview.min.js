...
*/
jet.add("tabview",function(b){var d=b.Base,e=b.Widget;b.Tab=d.create("tab",e,[b.WidgetChild],{ATTRS:{panelNode:{setter:b},triggerEvent:{value:"click"},labelContent:{value:""},panelContent:{value:""},href:{value:"#",writeOnce:true}},HTML_PARSER:{panel:function(){return this.get("parent").get("panelContainer").children(this.get("index"))},panelContent:function(){var a=this.get("panelNode");if(a)return a.html()},labelContent:function(){var a=this.get("contentBox");if(a)return a.html()}}},{BOUNDING_TEMPLATE:"<li/>",
CONTENT_TEMPLATE:"<a/>",PANEL_TEMPLATE:"<div/>",_uiTriggerEventChange:function(a){this.unbind(a.prevVal,this._selectHandler).on(a.newVal,this._selectHandler)},_uiTabLabelContentChange:function(a){var c=this.get("contentBox");c.children().remove();a.newVal instanceof b.NodeList?c.append(a.newVal):c.html(a.newVal)},_uiTabPanelContentChange:function(a){var c=this.get("panelNode");c.children().remove();a.newVal instanceof b.NodeList?c.append(a.newVal):c.html(a.newVal)},_uiTabSelectedChange:function(a){this.get("panelNode").toggleClass(this.getClassName("panel",
"selected"),a.newVal)},initializer:function(){this.get("panelNode")||this.set("panelNode",this.PANEL_TEMPLATE);var a=this.get("parent");a&&this.set("cssPrefix",a.get("cssPrefix"))},renderUI:function(){this.get("contentBox").attr("href",this.get("href")).html(this.get("labelContent"));var a=this.get("panelNode").html(this.get("panelContent")).addClass(this.getClassName("panel")),c=this.get("parent").get("panelContainer");a.parent()._nodes[0]!=c._nodes[0]&&a.appendTo(c)},bindUI:function(){this.on(this.get("triggerEvent"),
