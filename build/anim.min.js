...
a.off("enterFrame",this._enterFrame);this.set("previousTime",0);return this.set("startTime",0)},pause:function(){this.set("playing",false);var a=jet.TimeFrame;a.removeTween(this);a.off("enterFrame",this._enterFrame);return this.set("previousTime",(new Date).getTime()-this.get("startTime"))},reverse:function(){var a=this.get("from");return this.set("from",this.get("to")).set("to",a)},destructor:function(){this.stop()}});g.mix(g.NodeList.prototype,{animate:function(a,b,c,d){return this.defer(function(e){var f=
