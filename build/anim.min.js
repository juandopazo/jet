...
(1-a)*d[e]+a*d[parseInt(e+1,10)];return d[0]}};if(!jet.TimeFrame){var u=function(){var a=[],b,d=false;return{fps:50,play:function(){var c=this;if(!d){b&&clearInterval(b);b=setInterval(function(){c.fire("enterFrame",{time:(new Date).getTime()})},Math.round(1E3/c.fps));d=true}return c},stop:function(){b&&clearInterval(b);d=false;return this},addTween:function(c){a[a.length]=c;return this},removeTween:function(c){t.remove(c,a);return a.length===0?this.stop():this}}}();jet.TimeFrame=g.mix(new g.EventTarget,
...
a.unbind("enterFrame",this._enterFrame);this.set("previousTime",0);return this.set("startTime",0)},pause:function(){this.set("playing",false);var a=jet.TimeFrame;a.removeTween(this);a.unbind("enterFrame",this._enterFrame);return this.set("previousTime",(new Date).getTime()-this.get("startTime"))},reverse:function(){var a=this.get("from");return this.set("from",this.get("to")).set("to",a)},destructor:function(){this.stop()}});g.mix(g.NodeList.prototype,{animate:function(a,b,d,c){this.tw=(new s({node:this,
to:a,duration:b,easing:d})).on("end",c).play();return this},fadeIn:function(a,b,d){return this.animate({opacity:1},a,b,d)},fadeOut:function(a,b,d){return this.animate({opacity:0},a,b,d)},fadeToggle:function(a,b,d){return this.each(function(c){c=g(c);c.css("opacity")==1?c.fadeOut(a,b,d):c.fadeIn(a,b,d)})},slideDown:function(a,b,d){var c=this,e=c.css("overflow");return c.css("overflow","hidden").animate({height:c.oHeight},a,b,function(){c.css("overflow",e);d.call(c)})},slideUp:function(a,b,d){var c=
this,e=c.css("overflow");return c.css("overflow","hidden").animate({height:0},a,b,function(){c.css("overflow",e);d.call(c)})},stop:function(){this.tw&&this.tw.stop();return this}});g.add({Tween:s,Easing:n})});
