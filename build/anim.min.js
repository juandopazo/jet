...
v);b.addTween(a).play();return a};a.stop=function(){c=false;b.removeTween(a);b.unbind("enterFrame",v);t=n=0;return a};a.pause=function(){c=false;b.removeTween(a);b.unbind("enterFrame",v);t=(new Date).getTime()-n;return a};a.reverse=function(){return a.set("from",j).set("to",e)}};f.extend(o,f.Base);f.augment(f.NodeList,{animate:function(b,c,a,d){this.tw=(new o({node:this,to:b,duration:c,easing:a})).on("complete",d).play();return this},fadeIn:function(b,c,a){return this.animate({opacity:1},b,c,a)},
fadeOut:function(b,c,a){return this.animate({opacity:0},b,c,a)},fadeToggle:function(b,c,a){return this.each(function(d){d=f(d);d.css("opacity")==1?d.fadeOut(b,c,a):d.fadeIn(b,c,a)})},slideDown:function(b,c,a){var d=this,e=d.css("overflow");return d.css("overflow","hidden").animate({height:d.oHeight},b,c,function(){d.css("overflow",e);a.call(d)})},slideUp:function(b,c,a){var d=this,e=d.css("overflow");return d.css("overflow","hidden").animate({height:0},b,c,function(){d.css("overflow",e);a.call(d)})},
